...
func main() {
	...
	// Se comenta para no interrumpir el código por dispararse un error
...
// Usamos 'nil' como el Null, entonces si la function es exitosa retornamos el error como Null, no hubo error.
